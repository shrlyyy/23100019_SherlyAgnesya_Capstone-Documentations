'''
Challenge 15: Real-Time Weather Logger (API + CSV)

Build a Python CLI tool that fetches real-time weather data for given city and logs it to a CSV file for daily tracking.
...
API_KEY = "f5f1ed06434216459161c86698f0dc39"
