'''
Challenge 01: Self-Intro Script Generator

Create a Python script that interacts with the user anf generates a personalized self-introduction.
...
import datetime # Import library untuk tanggal/waktu.
...
# Penyusunan kalimat berdasarkan input user.
intro_message = (
...
# Menambahkan tanggal sesuai sistem dan masukkan ke teks intro_message.
