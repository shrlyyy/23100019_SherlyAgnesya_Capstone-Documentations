'''
Challenge 28: Crypto Price Tracker with Graphs

Goal:
- Fetch live prices of the top 10 cryptocurrencies using CoinGecko's free public API.- Store prices in a CSV file with timestamp.
...
PARAMS = {
    ...
    'per_page': 10,
    'page': 1,
    'sparkline': False # cari tau soal ini
}
